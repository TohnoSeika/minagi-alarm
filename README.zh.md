...
- 🖼️ **时钟模式** —— 小巧精致的时钟模式，可拖拽和缩放时间显示，最多支持添加 5 个便利贴并自定义便利贴内容,内置音乐播放器,支持播放导入的自定义音乐,支持随机播放模式
...
- 🚀 **性能** —— 安装包约 20MB，基于 Tauri v2 + Rust，瞬时启动
...
| 📝 **便利贴** | 时钟模式下右键空白区域添加便签（最多 5 个），可拖拽位置, / 双击编辑 / 在图钉上右键删除便利贴或导出 Markdown文件 |
...
在 Bilibili 观看介绍视频：[Minagi Alarm 介绍视频](https://www.bilibili.com/video/BV1duGK6CEdB)
...
> 💡 当前版本 **v1.5.0**，安装包约 20MB。Windows 安装包为 NSIS 安装程序。
